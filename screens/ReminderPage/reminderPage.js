...
const ReminderPage = () => {
  ...
  useEffect(() => {
    if (route.params?.selectedDays) {
      ...
      const selectedDayLabels = route.params.selectedDays.map(
        (dayId) => daysMap[dayId]
      );
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.settingOption}>
          ...
          <Switch value={snooze} onValueChange={(value) => setSnooze(value)} />
        </View>
