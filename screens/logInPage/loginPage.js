  ...
  return (
    <View style={styles.container}>
      <View style={styles.logo}>
        <Image style={{width: '100%', height: 200}} source={require('../../assets/img/logo/logo.jpg')}></Image>
      </View>
      <View style={styles.inputContainer}>
        <TextInput value={username} onChangeText={setUsername} style={styles.input} placeholder='Nhập số điện thoại hoặc email' placeholderTextColor={'#a5a4a4'}/>
        <TextInput value={password} onChangeText={setPassword} style={styles.input} placeholder='Nhập mật khẩu'  
        secureTextEntry = {true} placeholderTextColor={'#a5a4a4'}/>
        <View style={{display:'flex', flexDirection:'row', width: '100%', justifyContent: 'center'}}>
        <TouchableOpacity style={styles.button} onPress={handleLogin}>
          <Text style={styles.text}>Đăng Nhập</Text>
        </TouchableOpacity>
        <TouchableOpacity>
          <MaterialIcons name='fingerprint' size={45} color={'#616161'}/>
        </TouchableOpacity>
        </View>
